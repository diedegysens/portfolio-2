  ...
  <div class="layout2">
    ...
    <div class="container mx-auto p-4 animate-fade animate-once animate-delay-[500ms]" v-if="imageLoaded">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
        <!-- First column -->
        <div>
          <h1 class="text-2xl lg:text-4xl xl:text-6xl lg:mb-10 font-bold">{{ data.title }}</h1>
        <p class="text-xl lg:text-2xl xl:text-3xl lg:text-xl pb-10 font-bold">{{ data.description }}</p> 
