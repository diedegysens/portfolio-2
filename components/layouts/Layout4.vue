  ...
  <div class="layout2">
    <ClientOnly>
      ...
      <div class="container mx-auto p-4 animate-fade animate-once animate-delay-[500ms]" v-if="imageLoaded">
        ...
        <!-- Image gallery spanning both columns -->
        <div v-if="data.imagegallery && data.imagegallery.showgallery" class="mt-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div
              v-for="(image, index) in data.imagegallery.galleryImages"
              :key="index"
              class="relative"
            >
              <NuxtImg
      ...
      <Meta name="tags" :content="data.tags.join(', ')"></Meta>
      ...
      <Meta property="og:url" :content="data.url"></Meta>
